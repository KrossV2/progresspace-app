    ...
    <CardContent>
      <div className="space-y-4">
        <div className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-xl">
          <img src="/img/img1.png" alt="Math" className="h-8 w-8" />
        ...
        <div className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-xl">
          <img src="/img/img2.png" alt="English" className="h-8 w-8" />
          <div className="flex-1">
            <p className="font-medium">Ingliz tili</p>
            <p className="text-sm text-gray-500">10:30 - 11:30</p>
          </div>
          <Badge>Dars</Badge>
        </div>
      </div>
...
const TemporaryQuickCards = () => (
  <div className="space-y-4">
    <Card className="bg-gradient-to-r from-blue-500 to-purple-500 text-white">
      <CardContent className="p-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-blue-100">Joriy darslar</p>
            <p className="text-2xl font-bold">5</p>
          </div>
          <img src="/img/img1.png" alt="Lessons" className="h-8 w-8" />
        </div>
      </CardContent>
    </Card>
    ...
    <Card className="bg-gradient-to-r from-green-500 to-teal-500 text-white">
      <CardContent className="p-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-green-100">Bajarilgan vazifalar</p>
            <p className="text-2xl font-bold">12</p>
          </div>
          <img src="/img/img2.png" alt="Tasks" className="h-8 w-8" />
        </div>
      </CardContent>
    </Card>
    ...
    <Card className="bg-gradient-to-r from-orange-500 to-red-500 text-white">
      <CardContent className="p-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-orange-100">Yaqinlashayotgan testlar</p>
            <p className="text-2xl font-bold">3</p>
          </div>
          <img src="/img/img3.png" alt="Tests" className="h-8 w-8" />
        </div>
      </CardContent>
    </Card>
  </div>
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-4 text-white">
              <div className="flex items-center justify-between">
                ...
                <div className="text-3xl">
                  <img src="/img/img2.png" alt="Flame" className="h-8 w-8 object-contain" />
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between text-white">
              ...
              <div className="text-4xl">
                <img src="/img/img3.png" alt="Star" className="h-12 w-12 object-contain" />
              </div>
            </div>
          </CardContent>
        </Card>
...
function ActivityItem({ image, title, time, color }: ActivityItemProps) {
  ...
  return (
    <div className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600 hover:bg-white dark:hover:bg-gray-600 transition-colors">
      <div className={`p-2 rounded-lg ${colorClasses[color]} flex items-center justify-center`}>
        <img 
          src={image} 
          alt={title} 
